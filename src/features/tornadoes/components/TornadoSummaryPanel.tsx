...
export function TornadoSummaryPanel({
    ...
    return (
        <aside className="absolute right-3 top-20 z-20 hidden max-h-[calc(100dvh-220px)] w-80 overflow-y-auto rounded-lg border border-zinc-700/80 bg-zinc-950/90 p-4 text-sm text-zinc-300 shadow-2xl backdrop-blur-md md:block">
            ...
            <div className="mb-4 space-y-3">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-4 gap-1 text-xs">
                        {(Object.keys(SCALE_FILTER_LABELS) as TornadoScaleFilter[]).map((value) => (
                            <button
                                key={value}
                                type="button"
