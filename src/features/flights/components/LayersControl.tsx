...
import type { AirportSymbolMode, AllAirportsMetadata, StateSymbolMode, USStateStats } from '../types';
import {
...
type ActiveSection = 'none' | 'airports' | 'states';
                ...
                <div className="absolute right-0 mt-2 w-80 bg-gray-900/95 backdrop-blur border border-gray-700 rounded-lg shadow-xl overflow-hidden">
                    ...
                    <div className="p-3 space-y-2">
                        ...
                        <LayerToggle
                            ...
                            onChange={onShowFlightPathsChange}
                            color="purple"
                        />
...
// Simple toggle for layers without sub-options
...
function LayerToggle({ label, icon, checked, onChange, color }: LayerToggleProps) {
    ...
    return (
        <div className="flex items-center justify-between p-2 rounded-lg bg-gray-800/30 hover:bg-gray-800/50 transition-colors">
