...
export const BottomStatsBar = memo(function BottomStatsBar({
    ...
    return (
        <div
            className="absolute bottom-[calc(env(safe-area-inset-bottom,0px)+1rem)] left-4 right-16 sm:right-auto bg-gray-900/80 backdrop-blur px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-700 text-xs sm:text-sm"
            role="status"
            aria-live="polite"
        >
