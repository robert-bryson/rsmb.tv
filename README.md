...
- Tornado track data is generated from NOAA/NCEI StormEvents and stored under `public/data/tornadoes/` because the app loads the split per-year GeoJSON directly from the deployed site.
