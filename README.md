...
- Tornado track data is generated from NOAA/NCEI StormEvents and published to the S3/CDN-backed `https://data.rsmb.tv/tornadoes` dataset. Local `public/data/tornadoes/` files are development/backfill artifacts and are not committed.
